import { signInWithGithub } from '../lib/AuthProvider'
...
export default function GithubButton({ label = 'Log in with GitHub', onClick = signInWithGithub }) {
  return (
    <button type="button" className="btn btn-github" onClick={onClick}>
      <GithubMark />
      {label}
    </button>
  )
